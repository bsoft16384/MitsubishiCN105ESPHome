...
bool HeatpumpFunctions::is_valid() const { return _isValid1 && _isValid2; }
...
void HeatpumpFunctions::get_data1(uint8_t *data) const { memcpy(data, raw, 15); }

void HeatpumpFunctions::get_data2(uint8_t *data) const { memcpy(data, raw + 15, 15); }
...
int HeatpumpFunctions::get_code(uint8_t b) { return ((b >> 2) & 0xff) + 100; }

int HeatpumpFunctions::get_value(uint8_t b) { return b & 3; }
